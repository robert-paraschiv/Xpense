...
public class SpentMostUtils {
    ...
    public static void updateSpentMostOn(List<Transaction> values, String currency, SpentMostAdapter adapter, Activity context) {
        if (values == null || values.isEmpty()) {
            return;
        }

        HandlerThread handlerThread = new HandlerThread("updateSpentMostOn");
        handlerThread.start();
